...
<!-- Parent: Project -->
<!-- Title: Project Contributing GitFlow -->
...
To contribute to terraform-grafana-dashboard project on [GitHub](https://github.com/hadenlabs/terraform-grafana-dashboard), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-grafana-dashboard/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to terraform-grafana-dashboard project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/terraform-grafana-dashboard.git
```

Now your **upstream** points to **hadenlabs/terraform-grafana-dashboard**.
...
git fetch upstream # assuming upstream is rfid/terraform-grafana-dashboard
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/terraform-grafana-dashboard/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
